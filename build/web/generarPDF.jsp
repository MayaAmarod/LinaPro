<%-- 
    Document   : generarPDF
    Created on : 28/05/2021, 06:58:29 PM
    Author     : aamaya
//instalar plugins
//icono azul para conectar a base de datos de donde salen reportes
//new
// JDBC java db connectión
//name  reportes de proyecto
//web pages, nuevo Report -report wizard
// escribir o diseñar qwery
//martillo para compilar
//personalizar
//xml lenguaje cambiar de groovy a java

//exportar desde mi app
//nuevo jsp
...
File reporteProductos = new File(application.getRealPath("ReporteProductos.jasper"));
...
response.setHeader("Content-Disposition", "filename=\"ReporteProductos.pdf\";");
